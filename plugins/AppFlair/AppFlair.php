...
/****** Check if the user has the flair or not ******/
	...
	(
		$uniID		// <int> The UniID to check if they have the flair or not.
	,	$flairID	// <int> The flair ID to verify.
	)				// RETURNS <bool> TRUE if the user has this flair.
...
/****** Get the flair data for a specific user's tag ******/
	...
	(
		$uniID				// <int> The UniID that possess the flair.
	,	$flairID			// <int> The flair ID in possession.
	)						// RETURNS <str:mixed> the flair data.
...
/****** Get the list of flair for a specific site ******/
	...
	(
		$siteHandle		// <str> The site handle to pull flair from.
...
/****** Create a new flair type ******/
	...
	(
		$category			// <str> The category of the flair.
...
/****** Draw a flair tag ******/
	...
	(
		$flairData		// <str:mixed> The data of the flair to draw
	)					// RETURNS <str> the HTML to draw the flair tag
...
/****** Draw a flair list ******/
	...
	(
		$flairList				// <int:[str:mixed]> The list of flair data.
	,	$showCategories = false	// <bool> TRUE to show categories.
	)							// RETURNS <void> OUTPUTS the appropriate HTML.
