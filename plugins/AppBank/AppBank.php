...
/****** Create a bank account ******/
	...
	(
		$uniID		// <int> The UniID of the user creating the bank account.
...
/****** Rename a bank account ******/
	...
	(
		$uniID		// <int> The UniID of the user creating the bank account.
	,	$accountID	// <int> The ID of the bank account.
	,	$name		// <str> The name of the bank account.
	)				// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Get number of owned bank accounts *****/
	...
	)				// RETURNS <int> the number of owned accounts.
...
/***** Get list of owned bank accounts ******/
	...
	(
		$uniID		// <int> The UniID of the user we are checking for.
	)				// RETURNS <str:str> the list of owned bank accounts.
...
/***** Get list of shared bank accounts ******/
	...
	(
		$uniID		// <int> The UniID of the user we are checking for.
	)				// RETURNS <str:str> the list of shared bank accounts.
...
/****** Get Name ******/
	...
	(
		$uniID		// <int> The UniID of the user.
	,	$accountID	// <int> The ID of the bank account.
	)				// RETURNS <str:int> the list of people the account is shared with and their permissions.
...
/****** Deposit or Withdraw Auro ******/
	...
	(
		$uniID		// <int> The UniID of the bank account owner.
	,	$accountID	// <int> The ID of the bank account.
	,	$change		// <int> The deposit or withdrawal amount.
	,	$otherID = 0	// <int> The UniID of a user sharing the bank account, doing the action.
	)				// RETURNS <mixed> FALSE on failure, otherwise the new balance.
...
/****** Add user to bank account ******/
	...
	(
		$uniID		// <int> The UniID of the bank account owner.
	,	$accountID	// <int> The ID of the bank account.
	,	$otherID 	// <int> The UniID of a user sharing the bank account.
	,	$level		// <int> The access level. 0 is deposit only, 1 is full access.
	)				// RETURNS <bool> TRUE on success, FALSE on failure.
