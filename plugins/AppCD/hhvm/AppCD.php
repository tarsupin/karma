...
/****** Plugin Variables ******/
	public static array <str, int> $duration = array(1 => 10, 2 => 60, 3 => 120);	// <str:int>
	public static array <str, float> $interest = array(1 => 0.75, 2 => 5, 3 => 12);	// <str:float>
	
/****** Create a CD ******/
	public static function createAccount
	(
		int $uniID		// <int> The ID of the user creating the CD.
	,	int $plan		// <int> The plan to use: 1 for short, 2 for medium or 3 for long.
	,	int $amount		// <int> The amount of Auro to deposit.
...
/****** Get number of owned bank accounts *****/
	...
	): int				// RETURNS <int> the number of owned CD accounts.
...
/****** Get list of owned CDs ******/
	...
	(
		int $uniID		// <int> The UniID of the user we are checking for.
	): array <str, str>				// RETURNS <str:str> the list of owned CDs.
...
/****** Get CD data ******/
	...
	(
		int $uniID		// <int> The UniID of the user we are checking for.
	,	int $accountID	// <int> The ID of the CD to get data for.
	): array <str, str>				// RETURNS <str:str> the CD's data.
...
/****** Get Outcome ******/
	...
	(
		array <str, str> $data				// <str:str> The CD's data.
	,	bool $expired = false	// <bool> Returns 0 if set to TRUE and the CD hasn't matured yet.
	): int				// RETURNS <int> the outcome with interest.
...
/****** Mature CD ******/
	...
	,	int $accountID	// <int> The ID of the CD account.
	): bool				// RETURNS <bool> TRUE on success, FALSE on failure.
